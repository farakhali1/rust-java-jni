...
class test_rust {
  ...
  public static void main(String... args) {
    ...
    for (int i = 0; i < 1000; i++) {
      test_rust.add_numbers_rust(i, i); // warmup
    }
    ...
    for (int i = 0; i < 1000000; i++) {
      ...
      int x = test_rust.add_numbers_rust(i, i);
    ...
    //    test_rust.callback("java");
    // System.out.println("Sum of " + number_1 + " + " + number_2 + " = " +
    //                    test_rust.add_numbers_java(number_1, number_2));

    // // call rust functions
    // System.out.println("Sum of " + number_1 + " + " + number_2 + " = " +
    //                    test_rust.add_numbers_rust(number_1, number_2));
  }
